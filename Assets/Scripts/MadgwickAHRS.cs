...
namespace AHRS
{
    ...
    public class MadgwickAHRS
    {
        ...
        /// </summary>
        /// <param name="gyro">
        /// Gyroscope x,y,z axis measurement in radians/s.
        /// </param>
        /// <param name="acc">
        /// Accelerometer x,y,z axis measurement in any calibrated units.
        /// </param>
        /// <param name="mag">
        /// Magnetometer x,y,z axis measurement in any calibrated units.
        /// </param>
        /// <remarks>
        ...
        /// Total sqrt: 5
        /// </remarks> 
        public void Update(FusionVector gyro, FusionVector acc, FusionVector mag)
        {
            Update(gyro.x, gyro.y, gyro.z, acc.x, acc.y, acc.z, mag.x, mag.y, mag.z);
        }
        ...
        /// Total sqrt: 5
        /// </remarks> 
        public void Update(FusionVector gyro, FusionVector acc)
        {
            Update(gyro.x, gyro.y, gyro.z, acc.x, acc.y, acc.z);
        }
